...
const FilterTable = ({products, onFilterChange, uuid, type}) => {
    ...
    const handleFilter = async () => {
        ...
        console.log(filterValues);
        try {
            const res = await $API.get(`/product/${type}/${uuid}/`, {
                params: {
                    title: filterValues.titleProduct,
                    status: filterValues.status // Use filterValues.status here
                }
            });
        ...
        <div className={style.filterBox}>
            <div className={style.filterBox_panel}>
                ...
                <div className={style.filterBox_item}>
                    <input type="text" placeholder="Наименование" value={filterValues.titleProduct}
